...
\begin{minipage}[t]{0.33\textwidth}
    ...
    \textbullet{} MongoDB \textbullet{} SQLite \textbullet{}
...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \location{Spring \& Summer 2021 | Philadelphia, PA}
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
        ...
        \item Created visualizations in Kibana using the Elasticsearch stack to understand data
    ...
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
        \item Created and sold a program designed to improve grading efficiency by a factor of 20
