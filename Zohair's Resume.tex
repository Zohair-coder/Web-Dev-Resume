...
\begin{minipage}[t]{0.33\textwidth}
    ...
    %     \item Dean's List in all quarters
    % \end{tightemize}
    % Relevant Courses: \\
    % \begin{tightemize}
    ...
    % \location{General:}
    % \vspace{\topsep} % space added by myself; can be removed if needed
    Python3, Node.js \& ES6, React, FastAPI, Ruby, Go \\
    \vspace{\topsep} % space added by myself; can be removed if needed
    % \vspace{\topsep} % space added by myself; can be removed if needed
    % \location{Libraries \& Frameworks:}
    % \vspace{\topsep} % space added by myself; can be removed if needed
    % React \textbullet{} Numpy \textbullet{} Matplotlib \textbullet{} Requests \\ BeautifulSoup4 \textbullet{} Bootstrap 4 \\
    ...
    % \begin{tightemize}
        ...
        \location{(January 2022 - March 2022)}
        \textbf{\href{https://gitlab.com/Zohair-coder/market-sim}{gitlab.com/Zohair-coder/market-sim}} \\
        \vspace{\topsep}
        Led a team of 5 to create a stock market simulator to invest with virtual currency using React.js, Node.js, PostgreSQL and web sockets to get real time stock data
        
        \vspace{\topsep}
        
        % What's in your fridge
        \subsection{What's in Your Fridge?}
        \location{(September 2021 - March 2022)}
        ...
        \vspace{\topsep}
        Led a team of 4 to create a React webapp to help users find recipes based on ingredients they have in their fridge
        
        \vspace{\topsep}
        
        % Drexel Course Availability Notifier
        \subsection{Drexel Course Notifier}
        \location{(September 2020 - October 2020)}
        ...
        %       CS TA
        % \location{Teacher Assistant \\
        % (April 2021 - Current)}
        % \vspace{\topsep}
        % \vspace{\topsep}
        % \begin{tightemize}
        % \item Created and sold a program written in Python3 designed to improve grading efficiency by a factor of 20 for \$500
        ...
        % \location{Drexel Vertically Integrated Projects \\
        % (January 2021 - March 2021)}
        % \vspace{\topsep}
        % \begin{tightemize}
        %     \item Lead a team of 2 to program a Raspberry Pi in Bash using FFMPEG (command line program used to process video and audio) for recording video, compressing it, and uploading live stream to YouTube
        %     \item Learned Bash Scripting and FFMPEG in 1 week to complete the task
        % \end{tightemize}
        % \vspace{\topsep} % space added by myself; can be removed if needed
        
        % Head of IT
        % \location{Head of IT at school event}
        % \begin{tightemize}
...
\begin{minipage}[t]{0.66\textwidth}
    ...
    % SAP America - Second Year
    \subsection{SAP America}
    \descript{Software Engineering Intern - Artificial Intelligence}
    \location{April 2022 - Current | Philadelphia, PA}
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
    ...
    %       SAP America - First Year
    \subsection{SAP America}
    \descript{Software Engineer - Production Management Portals}
    \location{April 2021 - March 2022 | Philadelphia, PA}
    \begin{tightemize}
    ...
    \location{April 2021 - Current | Philadelphia, PA}
    \begin{tightemize}
    ...
    \location{April 2020 - June 2020 | Philadelphia, PA}
    \begin{tightemize}
    ...
    \location{January 2020 – March 2020 | Philadelphia, PA}
    \begin{tightemize}
    ...
    %       MarketSIM?
    % \runsubsection{MarketSIM}
    % \descript{| \href{https://gitlab.com/Zohair-coder/market-sim}{GitLab Link}}
    % \location{Winter 2021-22 | Philadelphia, PA}
    % \begin{tightemize}
    %     \item Led a team of 5 to create a stock market simulator for new investors to invest with virtual currency
    %     \item Wrote front-end in React.js, back-end in Node.js and used PostgreSQL database to store user data
    %     \item Used web sockets to get real time stock data from Alpaca API
    % \end{tightemize}

    %       What's in Your Fridge?
    % \runsubsection{What's in Your Fridge?}
    % \descript{| \href{https://gitlab.cci.drexel.edu/ci102-3teaml/whats_in_your_fridge/-/tree/main}{GitLab Link}}
    % \location{Fall 2021-22 | Philadelphia, PA}
    % \begin{tightemize}
    %     \item Led a team of 5 to create a React webapp to help users find recipes based on ingredients they have in their fridge
    %     % \item Utilized Google's MUI library to create a clean and intuitive user interface
    % \end{tightemize}
    %       Drexel Course Availability Notifier
    % \runsubsection{Drexel Course Availability Notifier}
    % \descript{| \href{https://github.com/Zohair-coder/Drexel-Course-Availability-Notifier}{GitHub Link}}
    % \location{Fall 2020-21 | Philadelphia, PA}
    % \begin{tightemize}
    ...
    % %       Tic Tac Toe AI
    % \runsubsection{Tic Tac Toe AI}
    % \descript{| \href{https://github.com/Zohair-coder/Tic-Tac-Toe-AI}{GitHub}}
    % \location{Summer 2020 | Philadelphia, PA}
    % \begin{tightemize}
