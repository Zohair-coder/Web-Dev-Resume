...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \location{Spring 2021 - Current | Philadelphia, PA}
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
    ...
    \location{Winter 2020 - Summer 2021 | Philadelphia, PA}
    \begin{tightemize}
    ...
    \descript{| \href{https://gitlab.cci.drexel.edu/ci102-3teaml/whats_in_your_fridge/-/tree/main}{GitLab}}
    \location{Fall 2021 | Philadelphia, PA}
    \begin{tightemize}
