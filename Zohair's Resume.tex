...
\begin{minipage}[t]{0.66\textwidth}
    ...
    \vspace{\topsep} % Hacky fix for awkward extra vertical space
    \begin{tightemize}
        \item Led a team of 2 to program a Raspberry Pi in Bash using FFMPEG (a command line tool used to process video and audio) for recording video, compressing it, and uploading it directly to live stream on YouTube in real time
